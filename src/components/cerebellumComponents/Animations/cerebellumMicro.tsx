...
const CerebellumMicro = () => {
    ...
    //FOR 'COMPLETION': Mobile: require clicks. Desktop: require clicks
    let animationComplete: string [] = ["CButton", "MButton", "PButton", "GButton", "WButton"];
    ...
    async function getMemberArray() {
        ...
        await axios.get<Member>(port, {params: {_id: id, animationCategory: "cerebellum", animationName: "micro"}})
...
export default CerebellumMicro;