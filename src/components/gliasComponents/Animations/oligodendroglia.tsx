...
const Oligodendroglia = () => {
    ...
    let animationComplete: string [] = ["axonBtn", "cytoplasmBtn", "mitochondrionBtn", "myelinBtn", "nodeBtn", "oligoBtn"];
    ...
    async function getMemberArray() {
        ...
        await axios.get<Member>(port, {params: {_id: id, animationCategory: "glias", animationName: "oligodendroglia"}})
