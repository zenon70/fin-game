...
const BrainDevelopment = () => {
    ...
    let aspectRatio = 800 / 400; //varies by animation
    ...
    */
    ...
    async function getMemberArray() {
        ...
        await axios.get<Member>(port, {params: {_id: id, animationCategory: "brain", animationName: "neural"}})
    ...
    function handleClick(event: Object) {
        ...
        if (obj[1].name === "step1") {
            axios.post<Member>(port, {
                _id: id,
                animationCategory: "brain",
                animationName: "neural",
                action: "play1",
    ...
    if (!isMobile) {
        return (
            <div style={{minHeight: '55vh', maxWidth: '70vw', margin: 'auto'}}>
                <AnimateCC
