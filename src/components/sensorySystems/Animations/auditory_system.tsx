...
const AuditorySystem = () => {
    ...
    let animationComplete: string [] = ["next", "next1", "next2", "auditory_cor", "medial_geniculate_body", "inferior_collic", "z", "lateral_lem", "cochlear_n", "super_oliv"];
    let needToCountHover: string [] = ["auditory_cor", "medial_geniuclate_body", "inferior_collic", "z", "lateral_lem", "cochlear_n", "super_oliv"];
    ...
    async function getMemberArray() {
        ...
        await axios.get<Member>(port, {params: {_id: id, animationCategory: "sensory", animationName: "auditory"}})
